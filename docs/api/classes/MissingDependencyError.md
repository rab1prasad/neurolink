...
[NeuroLink API Reference](../README.md) / MissingDependencyError

# Class: MissingDependencyError

Defined in: [server/errors.ts:530](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L530)
...
> **new MissingDependencyError**(`dependency`, `framework`, `installCommand?`): `MissingDependencyError`

Defined in: [server/errors.ts:531](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L531)
