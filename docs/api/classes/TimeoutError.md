...
[NeuroLink API Reference](../README.md) / TimeoutError

# Class: TimeoutError

Defined in: [server/errors.ts:274](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L274)
...
> **new TimeoutError**(`timeoutMs`, `operation?`, `requestId?`): `TimeoutError`

Defined in: [server/errors.ts:275](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L275)
