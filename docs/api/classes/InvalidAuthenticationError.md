...
[NeuroLink API Reference](../README.md) / InvalidAuthenticationError

# Class: InvalidAuthenticationError

Defined in: [server/errors.ts:216](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L216)
...
> **new InvalidAuthenticationError**(`message?`, `requestId?`): `InvalidAuthenticationError`

Defined in: [server/errors.ts:217](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L217)

#### Parameters

##### message?

`string` = `"Invalid authentication credentials"`
