...
[NeuroLink API Reference](../README.md) / AlreadyRunningError

# Class: AlreadyRunningError

Defined in: [server/errors.ts:416](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L416)
...
> **new AlreadyRunningError**(`port?`, `host?`): `AlreadyRunningError`

Defined in: [server/errors.ts:417](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L417)
