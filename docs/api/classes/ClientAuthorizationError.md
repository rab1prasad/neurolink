...
[NeuroLink API Reference](../README.md) / ClientAuthorizationError

# Class: ClientAuthorizationError

Defined in: [client/errors.ts:262](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/client/errors.ts#L262)
...
> **new ClientAuthorizationError**(`message?`, `options?`): `ClientAuthorizationError`

Defined in: [client/errors.ts:263](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/client/errors.ts#L263)

#### Parameters

##### message?

`string` = `"Access forbidden"`
