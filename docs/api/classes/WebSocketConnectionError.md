...
[NeuroLink API Reference](../README.md) / WebSocketConnectionError

# Class: WebSocketConnectionError

Defined in: [server/errors.ts:370](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L370)
...
> **new WebSocketConnectionError**(`message?`, `cause?`): `WebSocketConnectionError`

Defined in: [server/errors.ts:371](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L371)

#### Parameters

##### message?

`string` = `"WebSocket connection failed"`
