...
[NeuroLink API Reference](../README.md) / StreamingError

# Class: StreamingError

Defined in: [server/errors.ts:318](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L318)
...
> **new StreamingError**(`message`, `cause?`, `requestId?`): `StreamingError`

Defined in: [server/errors.ts:319](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L319)
