...
[NeuroLink API Reference](../README.md) / RouteNotFoundError

# Class: RouteNotFoundError

Defined in: [server/errors.ts:154](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L154)
...
> **new RouteNotFoundError**(`path`, `method`, `requestId?`): `RouteNotFoundError`

Defined in: [server/errors.ts:155](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/server/errors.ts#L155)
