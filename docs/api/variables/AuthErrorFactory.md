...
[NeuroLink API Reference](../README.md) / AuthErrorFactory

# Variable: AuthErrorFactory

> `const` **AuthErrorFactory**: `object`

Defined in: [auth/errors.ts:42](https://github.com/juspay/neurolink/blob/ff50c1e5a18abd666c68e6a6290bfe2015cb65b1/src/lib/auth/errors.ts#L42)
