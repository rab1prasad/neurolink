...
async function createVideo(name: string, actions: DemoAction[]): Promise<void> {
...
const basicExamplesActions: DemoAction[] = [
  {
    description:
...
const businessUseCasesActions: DemoAction[] = [
  {
...
const creativeToolsActions: DemoAction[] = [
  {
...
const developerToolsActions: DemoAction[] = [
  {
...
const monitoringActions: DemoAction[] = [
  {
...
// Main execution
async function createAllVideos(): Promise<void> {
