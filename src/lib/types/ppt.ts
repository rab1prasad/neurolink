...
// PPTError class and PPT_ERROR_CODES constant moved to
// src/lib/features/ppt/pptError.ts to break a circular import:
// types/ppt.ts → utils/errorHandling.ts (NeuroLinkError) → types/index.js (barrel)
// → re-exports types/ppt.ts → TDZ error at runtime.
